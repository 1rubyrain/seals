...
public class SealsMod {
    ...
    public static class SealsConfig {
        @ConfigEntry(name = "Drop sponge on death", multiplayerSynced = true,
                description = "If enabled, seals will have a 1/5 chance to drop a sponge block on death")
        public Boolean dropSpongeOnDeath = false;

        @ConfigEntry(name = "Seals with hats despawn", multiplayerSynced = true,
                description = "If enabled, seals with hats will despawn as normal")
        public Boolean sealsWithHatsDespawn = false;
